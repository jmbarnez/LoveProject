return {
    ...
    icon = {
        ...
        shapes = {
            ...
            -- Salvaging focuser
            { type = "rectangle", mode = "fill", color = {1.0, 0.2, 0.6, 1}, x = 11, y = 14, w = 10, h = 3, rx = 1 },
            { type = "rectangle", mode = "fill", color = {1.0, 0.3, 0.7, 0.9}, x = 12, y = 18, w = 8, h = 2, rx = 1 },
            -- Laser emitter
            { type = "circle", mode = "fill", color = {0.6, 0.1, 0.4, 1}, x = 16, y = 8, r = 5 },
            { type = "circle", mode = "fill", color = {1.0, 0.2, 0.6, 0.95}, x = 16, y = 8, r = 3.2 },
            { type = "circle", mode = "fill", color = {1.0, 0.4, 0.8, 0.8}, x = 16, y = 8, r = 1.6 },
        }
    },
    ...
    -- Visual effects
    tracer = { color = {1.0, 0.2, 0.6, 0.8}, width = 5, coreRadius = 4 }, -- Pink
    impact = {
        shield = { spanDeg = 90, color1 = {1.0, 0.2, 0.6, 0.6}, color2 = {0.8, 0.1, 0.4, 0.4} }, -- Pink
        hull = { spark = {1.0, 0.3, 0.7, 0.8}, ring = {0.8, 0.1, 0.4, 0.6} }, -- Pink
    },
