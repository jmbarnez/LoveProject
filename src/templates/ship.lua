...
function Ship.new(x, y, angle, friendly, shipConfig)
  ...
  self.components = {
      ...
      windfield_physics = WindfieldPhysics.new({
        ...
        x = x,
        y = y,
        colliderType = (shipConfig.windfield_physics and shipConfig.windfield_physics.colliderType) or (shipConfig.collidable and shipConfig.collidable.shape) or "circle",
        bodyType = "dynamic",
        restitution = 0.1,
        friction = 0.3,
        fixedRotation = shipConfig.fixedRotation == false and false or true,
        radius = (shipConfig.windfield_physics and shipConfig.windfield_physics.colliderType == "circle") and radius or nil,
        vertices = (shipConfig.windfield_physics and shipConfig.windfield_physics.vertices) or (shipConfig.collidable and shipConfig.collidable.vertices),
      }),
